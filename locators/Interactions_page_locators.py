...
class SelectablePageLocators:
    ...
    GRID_ITEM_ACTIVE = (
        By.CSS_SELECTOR, 'div[id="demo-tabpane-grid"] li[class="list-group-item active list-group-item-action"]')
...
class DraggablePageLocators:
    ...
    DRAG_ME = (By.CSS_SELECTOR, 'div[id="draggableExample-tabpane-simple"] [id="dragBox"]')
    # Axis Restricted
