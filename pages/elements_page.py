...
class TextBoxPage(BasePage):
    ...
    def fill_all_fields(self):
        ...
        permanents_address = person_info.permanent_address
        with allure.step("Заполнение полей"):
            self.element_is_visible(self.locators.FULL_NAME).send_keys(full_name)
            self.element_is_visible(self.locators.EMAIL).send_keys(email)
            self.element_is_visible(self.locators.CURRENT_ADDRESS).send_keys(current_address)
            self.element_is_visible(self.locators.PERMANENT_ADDRESS).send_keys(permanents_address)
        with allure.step('Нажатие кнопки'):
            self.element_is_visible(self.locators.SUBMIT).click()
        return full_name, email, current_address, permanents_address
...
class CheckBoxPage(BasePage):
    ...
    @allure.step("Открытие полного списка")
    def open_full_list(self):
        self.element_is_visible(self.locators.EXPAND_ALL_BUTTON).click()

    @allure.step("Клик случайного чекбокса")
    ...
    @allure.step("Проверка уже выбранного чекбоска")
    ...
    @allure.step("Получение значения на выходе")
...
class RadioButtonPage(BasePage):
    ...
    @allure.step("Нажатие кнопки Radio")
    def click_on_the_radio_button(self, choice):
        choices = {'yes': self.locators.AGREE_RADIO_BUTTON,
                   'impressive': self.locators.IMPRESSIVE_RADIO_BUTTON,
                   'no': self.locators.NO_RADIO_BUTTON, }
        self.element_is_visible(choices[choice]).click()

    @allure.step("Получение значение нажатой Radio")
    def get_output_radio(self):
        return self.element_is_present(self.locators.OUTPUT_RESULT_RADIO)


class WebTablePage(BasePage):
    locators = WebTablePageLocators()

    @allure.step("Добавление нового человека")
    ...
    @allure.step("Проверка добавленного человека")
    ...
    @allure.step("Поиск какого-либо человека")
    def search_some_person(self, key_word):
        self.element_is_visible(self.locators.SEARCH_INPUT).send_keys(key_word)

    @allure.step("Проверка найденного человека")
    def check_search_person(self):
        delete_button = self.element_is_present(self.locators.DELETE_BUTTON)
        row = delete_button.find_element('xpath', self.locators.ROW_PARENT)
        return row.text.splitlines()

    @allure.step("Обновления данных о человеке")
    ...
    @allure.step("Удаление человека")
    def delete_person(self):
        self.element_is_visible(self.locators.DELETE_BUTTON).click()

    @allure.step("Проверка удаленного человека")
    def check_deleted(self):
        return self.element_is_present(self.locators.NO_ROWS_FOUND).text

    @allure.step("Выбор нескольких рядов")
    ...
    @allure.step("Проверка количества рядов")
...
class ButtonsPage(BasePage):
    ...
    @allure.step("Клик различной кнопки")
...
class LinksPage(BasePage):
    ...
    @allure.step("Проверка новой ссылки")
    ...
    @allure.step("Проверка неработающей ссылки")
...
class UploadAndDownloadPage(BasePage):
    ...
    @allure.step("Загрузка файла на страницу")
    ...
    @allure.step("Загрузка файла с страницы")
    def download_file(self):
        link = self.element_is_present(self.locators.DOWNLOAD_FILE).get_attribute('href')
        link_b = base64.b64decode(link)
        path_name_file = rf'C:\Users\aptem\PycharmProjects\automation_qa_practice\filetest{random.randint(0, 999)}.jpg'
...
class DynamicPropertiesPage(BasePage):
    ...
    @allure.step("Проверка кнопки включения")
    ...
    @allure.step("Проверка изменения цвета")
